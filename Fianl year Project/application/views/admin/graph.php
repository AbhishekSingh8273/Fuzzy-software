...
<head>
  <meta charset="UTF-8">
  <title>Chart.js in bootstrap modal</title>
                    ...
                    <div class="table-responsive">
                        <table id="business_ratio" class="table table-condensed table-bordered table-striped table-hover table-charts">
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <a href='#' data-toggle='modal' data-target='#modChart' data-source='10.1,59.47,80.00,81.11,56.67,55.45,40.88,20.45,40.98,80.66,88.34,61.01' data-target-source='50'>
